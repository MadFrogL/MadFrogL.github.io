...
excerpt: 'In this paper, we propose WiAnchor, a novel training framework for efficient cross-domain adaptation, and NFS-Fi, a multi-person near-field sensing dataset. [Code](https://github.com/DeepWiSe888/NFS-Fi)'
date: 2026-08-30
venue: 'IEEE TPAMI'
